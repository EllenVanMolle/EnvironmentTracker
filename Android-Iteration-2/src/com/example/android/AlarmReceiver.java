...
public class AlarmReceiver extends BroadcastReceiver {
	...
	private static final String KEY_PREF_START = "pref_StartNotTime"; // Keyvalue
																		// for
																		// StartNotTime
	private static final String KEY_PREF_STOP = "pref_StopNotTime";// Keyvalue
																	// for
																	// StopNotTime
	...
	private void buildNotification(Context context) {
		...
		Notification notification = new NotificationCompat.Builder(context)
				...
				// icon that appears in left corner of screen
				.setContentTitle(Not_Title).setContentText(Not_Content)
				.setTicker(Not_Ticker) // text that appears on top of the screen
										// when notification is received
				.setDefaults(0xffffffff) // all notification properties will be
											// inherited from system defaults
				.setContentIntent(pendingIntent) // action taken when
	...
	private boolean CheckTime(Context context) {
		...
		Toast.makeText(context,
				"StopHour: " + StopHour + " StopMinute: " + StopMinute,
				Toast.LENGTH_LONG).show();
		...
		// return true if time is between start and stop hour, otherwise return
		// false
