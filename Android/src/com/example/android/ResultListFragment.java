...
public class ResultListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Provides the cursor for the listview.
		...
		setListAdapter(new ArrayAdapter<Chart>(getActivity(),
				...
				android.R.id.text1, ResultsContent.charts));
	}

	/**
	 * Create the view once the hierarchy is created. The view is the view
	 * returned by onCreateView. (You can overwrite that.)
	 */
	@Override
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(ResultsContent.chartsMap.get(Integer.toString(position+1)).getId());
	}
