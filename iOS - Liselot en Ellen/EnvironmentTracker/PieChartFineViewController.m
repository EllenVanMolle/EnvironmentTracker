...
@implementation PieChartFineViewController
...
-(void)configureGraph {
    ...
    // Configure title
    NSString *title = @"% of every color when you're fine!";
    graph.title = title;
...
-(NSUInteger)numberOfRecordsForPlot:(CPTPlot *)plot {
    NSUInteger numberSlices = [self.model.hueFine count];
...
-(NSNumber *)numberForPlot:(CPTPlot *)plot field:(NSUInteger)fieldEnum recordIndex:(NSUInteger)index {
    ...
    { 
        NSNumber *sliceValue = [self.model.hueFine objectAtIndex:(index)];
        return sliceValue;
    }
...
-(CPTLayer *)dataLabelForPlot:(CPTPlot *)plot recordIndex:(NSUInteger)index {
    ...
    for (NSNumber *sliceValue in self.model.hueFine) {
