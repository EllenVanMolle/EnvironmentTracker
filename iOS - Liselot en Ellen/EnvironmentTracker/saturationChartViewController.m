...
-(void)configureGraph {
    ...
    // Set up plot space
    CGFloat xMin = 0.0f;
    CGFloat xMax = 100.0f;  // maximum value for the saturation
    CGFloat yMin = 0.0f;
...
/* Method that returns the number of bars in the plot (this is 11 and not 10 because 0 is also a possibility*/
